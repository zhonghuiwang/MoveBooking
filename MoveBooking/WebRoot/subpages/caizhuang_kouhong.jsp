...
<div class="products-show-box-title">
    <ul>
        ...
        <li>-</li>
        <li><a class="active-title">口红</a></li>
    ...
    <div id="outBox">
        <div class="leftBox">
            <div class="normalBox w">
                <div class="w" id="n"><img src="../images/kouhong.jpg"></div>
            </div>
            <div class="botBox">
            </div>
        </div>
                    ...
                    <table width="490" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td width="347" class="price">
                                ...
                                <li><label><input name="size" type="radio" value="" />303</label></li>
                                    <li><label><input name="size" type="radio" value="" />503</label></li>
                                    <li><label><input name="size" type="radio" value="" />105</label></li>
                            </ul>
                            </td>
                        </tr>
                        <tr>
                            <td height="40" width="65"><div align="center">大小</div></td>
                            <td class="time">
                                <ul class="statistics2">
                <li><label><input name="color" type="radio" value="" />大</label></li>
                <li><label><input name="color" type="radio" value="" />中</label></li>
                <li><label><input name="color" type="radio" value="" />小</label></li>
                                </ul></td>
                        </tr>
                        <tr>
...
<ul class="shop-title">完美彩妆品牌
    <li>公司名称：完美彩妆</li>
    <li>保证金：3000￥</li>
    <li>所在地：内蒙古乌兰浩特市</li>
    <li>地址：内蒙古乌兰浩特市百货大楼一楼专柜</li>
...
<div class="detail-title">
    ...
    <div class="detail" id="con_two_1">
      并且该商品参与了公益宝贝计划，每卖出一份都有0.5元贡献给慈善事业！
    </div>
...
<script type="text/javascript" charset="utf-8">
    function redirectionhtml(){
        var url=encodeURI("口红");
        window.location.href = "user-order.jsp?image=../images/kouhong.jpg&name="+url+"&price=100";
    }
</script>
<script type="text/javascript" charset="utf-8">
    function gocart(){
        var url=encodeURI("口红");
        window.location.href = "../cart.jsp?image=images/kouhong.jpg&name="+url+"&price=100";
    }
</script>
<!--选项卡js-->
