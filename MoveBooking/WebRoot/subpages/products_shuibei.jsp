...
<div class="products-show-box-title">
    <ul>
        ...
        <li>-</li>
        <li><a class="active-title">精品水杯 推荐款</a></li>
    ...
    <div id="outBox">
        <div class="leftBox">
            <div class="normalBox w">
                <div class="w" id="n"><img src="../images/shuibei.jpg"></div>
            </div>
            <div class="botBox">
            </div>
        </div>
        ...
        <div class="products-box-mid-content">
            <h1 style="font-size: 16px;">精品水杯 推荐款</h1>
            <ul class="ul-box">
                <li>
                    <table width="490" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="65" height="40"><div align="center">官网价格：</div></td>
                        <td width="347" class="price" style="text-decoration:line-through;color: #666666;">￥24.99</td>
                    </tr>
                        <tr>
                            <td width="65" height="40"><div align="center">VIP价格：</div></td>
                            <td width="347" class="price">￥14.9</td>
                        </tr>
                    <tr>
                        <td height="40" width="65"><div align="center">上架时间：</div></td>
                        <td class="time">2013年01月份</td>
                    </tr>
                    <tr>
                        <td height="40" width="65"><div align="center">品牌：</div></td>
                        <td class="time">xash环保水杯</td>
                    </tr>
                </table>
                </li>
                <li>
                    <ul class="statistics">
                        <li>月销量<span class="count">254654</span>+</li>
                        <li>累计评价<span class="count">54651</span>+</li>
                        <li>关注<span class="count">947414</span>+</li>
                    </ul>
                </li>
                <li>
                    <table width="490" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td width="347" class="price">
                                ...
                                <li><label><input name="size" type="radio" value="" />300ml</label></li>
                                    <li><label><input name="size" type="radio" value="" />500ml</label></li>
                                    <li><label><input name="size" type="radio" value="" />600ml</label></li>
                            </ul>
                            </td>
                        </tr>
                        <tr>
...
<div class="detail-title">
    ...
    <div class="detail" id="con_two_1">
        本产品水杯采用了全包裹方式，可以再您使用时更好地保护您的安全，并且该商品参与了公益宝贝计划，每卖出一份都有0.5元贡献给慈善事业！
    </div>
    <div class="detail2" id="con_two_2">
        <table width="978" border="0" cellpadding="0" cellspacing="0" class="pinglun" >
            <tr bgcolor="#fafafa">
                ...
                <td width="404" style="font-size: 14px;">挺好的，挺好的，用了喝热水时不会烫手</td>
            ...
            <tr bgcolor="#fafafa">
                ...
                <td width="404" style="font-size: 14px;">很不错，一点也不烫手，而且不会漏水</td>
                <td width="404"><div align="center" style="font-size: 14px;color: #666666;">2013-01-13 15:06</div></td>
            </tr>
            <tr bgcolor="#fafafa">
                <td width="86" height="80"><div align="center" style="font-size: 14px;">王夏林</div></td>
                <td width="404" style="font-size: 14px;">很好，很喜欢这个杯子</td>
                <td width="404"><div align="center" style="font-size: 14px;color: #666666;">2013-01-13 15:06</div></td>
            </tr>
        </table>
...
<script type="text/javascript" charset="utf-8">
    function redirectionhtml(){
        var url=encodeURI("水杯");
        window.location.href = "user-order.jsp?image=../images/shuibei.jpg&name="+url+"&price=14.9";
    }
</script>
<script type="text/javascript" charset="utf-8">
    function gocart(){
        var url=encodeURI("水杯");
        window.location.href = "../cart.jsp?image=images/shuibei.jpg&name="+url+"&price=14.9";
    }
</script>
<!--选项卡js-->
