...
<div class="products-show-box-title">
    <ul>
        ...
        <li>-</li>
        <li><a class="active-title">榨汁机</a></li>
    ...
    <div id="outBox">
        <div class="leftBox">
            <div class="normalBox w">
                <div class="w" id="n"><img src="../images/zhazhiji.jpg"></div>
            </div>
            <div class="botBox">
            </div>
        </div>
        ...
        <div class="products-box-mid-content">
            <h1 style="font-size: 16px;">榨汁机</h1>
            <ul class="ul-box">
                <li>
                    ...
                    <tr>
                        ...
                        <tr>
                            ...
                            <td width="347" class="price">￥149.9</td>
                        </tr>
                    <tr>
...
<div class="detail-title">
    ...
    <div class="detail" id="con_two_1">
       本品牌榨汁机，功能齐全，并且该商品参与了公益宝贝计划，每卖出一份都有0.5元贡献给慈善事业！
    </div>
...
<script type="text/javascript" charset="utf-8">
    function redirectionhtml(){
        var url=encodeURI("榨汁机");
        window.location.href = "user-order.jsp?image=../images/zhazhiji.jpg&name="+url+"&price=149.9";
    }
</script>
<script type="text/javascript" charset="utf-8">
    function gocart(){
        var url=encodeURI("榨汁机");
        window.location.href = "../cart.jsp?image=images/zhazhiji.jpg&name="+url+"&price=149.9";
    }
</script>
<!--选项卡js-->
