...
<div class="products-show-box-title">
    <ul>
        ...
        <li>-</li>
        <li><a class="active-title">草莓</a></li>
    ...
    <div id="outBox">
        <div class="leftBox">
            <div class="normalBox w">
                <div class="w" id="n"><img src="../images/caomei.jpg"></div>
            </div>
            <div class="botBox">
            </div>
        </div>
...
<script type="text/javascript" charset="utf-8">
    function redirectionhtml(){
        var url=encodeURI("草莓");
        window.location.href = "user-order.jsp?image=../images/caomei.jpg&name="+url+"&price=25";
    }
</script>
<script type="text/javascript" charset="utf-8">
    function gocart(){
        var url=encodeURI("草莓");
        window.location.href = "../cart.jsp?image=images/caomei.jpg&name="+url+"&price=25";
    }
</script>
<!--选项卡js-->
