...
<div class="products-show-box-title">
    <ul>
        ...
        <li>-</li>
        <li><a class="active-title">拖布</a></li>
    ...
    <div id="outBox">
        <div class="leftBox">
            <div class="normalBox w">
                <div class="w" id="n"><img src="../images/tuobu.jpg"></div>
            </div>
            <div class="botBox">
            </div>
        </div>
        ...
        <div class="products-box-mid-content">
            <h1 style="font-size: 16px;">拖把</h1>
            <ul class="ul-box">
                <li>
                    <table width="490" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="65" height="40"><div align="center">官网价格：</div></td>
                        <td width="347" class="price" style="text-decoration:line-through;color: #666666;">￥30</td>
                    </tr>
                        <tr>
                            <td width="65" height="40"><div align="center">VIP价格：</div></td>
                            <td width="347" class="price">￥24.6</td>
                        </tr>
                    <tr>
                ...
                <li>
                    <table width="490" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td class="time">
                                <ul class="statistics2">
                <li><label><input name="color" type="radio" value="" />拖把</label></li>
                <li><label><input name="color" type="radio" value="" />拖把+桶</label></li>
                <li><label><input name="color" type="radio" value="" />桶</label></li>
                                </ul></td>
                        </tr>
                        <tr>
...
<div class="detail-title">
    ...
    <div class="detail" id="con_two_1">
        契合人体工学设计，拖地不在疲惫，并且该商品参与了公益宝贝计划，每卖出一份都有0.5元贡献给慈善事业！
    </div>
    <div class="detail2" id="con_two_2">
        <table width="978" border="0" cellpadding="0" cellspacing="0" class="pinglun" >
            <tr bgcolor="#fafafa">
                ...
                <td width="404" style="font-size: 14px;">挺好的，挺好的，地拖得很干净</td>
            ...
            <tr bgcolor="#fafafa">
                ...
                <td width="404" style="font-size: 14px;">很好，用着很方便</td>
                <td width="404"><div align="center" style="font-size: 14px;color: #666666;">2013-01-13 15:06</div></td>
            </tr>
        </table>
...
<script type="text/javascript" charset="utf-8">
    function redirectionhtml(){
        var url=encodeURI("拖把");
        window.location.href = "user-order.jsp?image=../images/tuobu.jpg&name="+url+"&price=24.6";
    }
</script>
<script type="text/javascript" charset="utf-8">
    function gocart(){
        var url=encodeURI("拖把");
        window.location.href = "../cart.jsp?image=images/tuobu.jpg&name="+url+"&price=24.6";
    }
</script>
<!--选项卡js-->
