...
<ul>
    ...
    <li class="goods-products">
        <span><a href="../subpages/shucai_lajiao.jsp"><img src="../images/lajiao.jpg" alt="" width="250" height="215" class="main-img"></a></span>
        <div class="goods-title">
            <a href="../subpages/shucai_lajiao.jsp">辣椒</a>
        </div>
    ...
    <li class="goods-products">
        <span><a href="../subpages/shucai_xilanhua.jsp"><img src="../images/xilanhua.jpg" alt="" width="250" height="215" class="main-img"></a></span>
        <div class="goods-title">
            <a href="../subpages/shucai_xilanhua.jsp">西蓝花</a>
        </div>
        <div class="goods-label">
            <ul>
                <li><a class="procuts-label" title="包邮">包邮</a></li>
        ...
        <span class="goods-money">￥3.00</span>
        <span class="goods-shop-name"><a href=""><img src="../images/icon/kefu.png" width="20" height="20"></a></span>
    </li>
</ul>
