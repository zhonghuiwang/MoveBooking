...
<div class="products-show-box-title">
    <ul>
        ...
        <li>-</li>
        <li><a class="active-title">饮水机</a></li>
    ...
    <div id="outBox">
        <div class="leftBox">
            <div class="normalBox w">
                <div class="w" id="n"><img src="../images/yinshuiji.jpg"></div>
            </div>
            <div class="botBox">
            </div>
        </div>
...
<div class="detail-title">
    ...
    <div class="detail" id="con_two_1">
       本品牌饮水机，功能齐全，净水能力强，并且该商品参与了公益宝贝计划，每卖出一份都有0.5元贡献给慈善事业！
    </div>
...
<script type="text/javascript" charset="utf-8">
    function redirectionhtml(){
        var url=encodeURI("饮水机");
        window.location.href = "user-order.jsp?image=../images/yinshuiji.jpg&name="+url+"&price=200";
    }
</script>
<script type="text/javascript" charset="utf-8">
    function gocart(){
        var url=encodeURI("饮水机");
        window.location.href = "../cart.jsp?image=images/yinshuiji.jpg&name="+url+"&price=200";
    }
</script>
<!--选项卡js-->
