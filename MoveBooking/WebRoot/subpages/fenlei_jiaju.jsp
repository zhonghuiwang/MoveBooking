...
<ul>
    ...
    <li class="goods-products">
        <span><a href="../subpages/weishengzhi.jsp"><img src="../images/weishengzhi.jpg" alt="" width="250" height="215" class="main-img"></a></span>
        <div class="goods-title">
            <a href="../subpages/weishengzhi.jsp">卫生纸</a>
        </div>
        ...
        <span class="goods-money">￥9.99</span>
        <span class="goods-shop-name"><a href=""><img src="../images/icon/kefu.png" width="20" height="20"></a></span>
    </li>

    <li class="goods-products">
        <span><a href="../subpages/tuobu.jsp"><img src="../images/tuobu.jpg" alt="" width="250" height="215" class="main-img"></a></span>
        <div class="goods-title">
        ...
        <span class="goods-money">￥24.6</span>
        <span class="goods-shop-name"><a href=""><img src="../images/icon/kefu.png" width="20" height="20"></a></span>
    </li>
</ul>
