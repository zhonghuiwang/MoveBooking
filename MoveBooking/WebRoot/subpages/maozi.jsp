...
<div class="products-show-box-title">
    <ul>
        ...
        <li>-</li>
        <li><a class="active-title">帽子</a></li>
    ...
    <div id="outBox">
        <div class="leftBox">
            <div class="normalBox w">
                <div class="w" id="n"><img src="../images/maozi.jpg"></div>
            </div>
            <div class="botBox">
            </div>
        </div>
        ...
        <div class="products-box-mid-content">
            <h1 style="font-size: 16px;">帽子</h1>
            <ul class="ul-box">
                <li>
                    <table width="490" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="65" height="40"><div align="center">官网价格：</div></td>
                        <td width="347" class="price" style="text-decoration:line-through;color: #666666;">￥45</td>
                    </tr>
                        <tr>
                            <td width="65" height="40"><div align="center">VIP价格：</div></td>
                            <td width="347" class="price">￥25.5</td>
                        </tr>
                    <tr>
...
<ul class="shop-title">丽人服装
    <li>公司名称：丽人服装</li>
    <li>保证金：2000￥</li>
    <li>所在地：内蒙古乌兰浩特市</li>
    <li>地址：内蒙古乌兰浩特市美中美一楼</li>
...
<div class="detail-title">
    ...
    <div class="detail" id="con_two_1">
        优质布料，不易变形，并且该商品参与了公益宝贝计划，每卖出一份都有0.5元贡献给慈善事业！
    </div>
    <div class="detail2" id="con_two_2">
        <table width="978" border="0" cellpadding="0" cellspacing="0" class="pinglun" >
            <tr bgcolor="#fafafa">
                ...
                <td width="404" style="font-size: 14px;">挺好的，挺好的，很好看</td>
            ...
            <tr bgcolor="#fafafa">
                ...
                <td width="404" style="font-size: 14px;">很不错，戴着很好</td>
                <td width="404"><div align="center" style="font-size: 14px;color: #666666;">2013-01-13 15:06</div></td>
            </tr>
            <tr bgcolor="#fafafa">
                <td width="86" height="80"><div align="center" style="font-size: 14px;">王夏林</div></td>
                <td width="404" style="font-size: 14px;">很好，很好看</td>
                <td width="404"><div align="center" style="font-size: 14px;color: #666666;">2013-01-13 15:06</div></td>
            </tr>
        </table>
...
<script type="text/javascript" charset="utf-8">
    function redirectionhtml(){
        var url=encodeURI("帽子");
        window.location.href = "user-order.jsp?image=../images/maozi.jpg&name="+url+"&price=25.5";
    }
</script>
<script type="text/javascript" charset="utf-8">
    function gocart(){
        var url=encodeURI("帽子");
        window.location.href = "../cart.jsp?image=images/maozi.jpg&name="+url+"&price=25.5";
    }
</script>
<!--选项卡js-->
