...
<ul>
    ...
    <li class="goods-products">
        <span><a href="../subpages/maozi.jsp"><img src="../images/maozi.jpg" alt="" width="250" height="215" class="main-img"></a></span>
        ...
        <span class="goods-money">￥25.5</span>
        <span class="goods-shop-name"><a href=""><img src="../images/icon/kefu.png" width="20" height="20"></a></span>
    </li>

    <li class="goods-products">
        <span><a href="../subpages/xiezi.jsp"><img src="../images/xiezi.jpg" alt="" width="250" height="215" class="main-img"></a></span>
        <div class="goods-title">
            <a href="../subpages/xiezi.jsp">鞋</a>
        </div>
        <div class="goods-label">
            <ul>
                <li><a class="procuts-label" title="包邮">包邮</a></li>
        ...
        <span class="goods-money">￥238.0</span>
        <span class="goods-shop-name"><a href=""><img src="../images/icon/kefu.png" width="20" height="20"></a></span>
    </li>
</ul>
