...
<ul>
    ...
    <li class="goods-products">
        <span><a href="../subpages/benzi_benzi1.jsp"><img src="../images/benzi1.jpg" alt="" width="250" height="215" class="main-img"></a></span>
        <div class="goods-title">
            <a href="../subpages/benzi_benzi1.jsp">本子</a>
        </div>
    ...
    <li class="goods-products">
        <span><a href="../subpages/benzi_benzi2.jsp"><img src="../images/benzi2.jpg" alt="" width="250" height="215" class="main-img"></a></span>
        <div class="goods-title">
            <a href="../subpages/benzi_benzi2.jsp">本子</a>
        </div>
        <div class="goods-label">
            <ul>
                <li><a class="procuts-label" title="包邮">包邮</a></li>
