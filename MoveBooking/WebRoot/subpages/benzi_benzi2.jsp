    ...
    <div id="outBox">
        <div class="leftBox">
            <div class="normalBox w">
                <div class="w" id="n"><img src="../images/benzi2.jpg"></div>
            </div>
            <div class="botBox">
            </div>
        </div>
...
<script type="text/javascript" charset="utf-8">
    function redirectionhtml(){
        ...
        window.location.href = "user-order.jsp?image=../images/benzi2.jpg&name="+url+"&price=5";
    }
</script>
<script type="text/javascript" charset="utf-8">
    function gocart(){
        var url=encodeURI("本子");
        window.location.href = "../cart.jsp?image=images/benzi2.jpg&name="+url+"&price=5";
    }
</script>
<!--选项卡js-->
