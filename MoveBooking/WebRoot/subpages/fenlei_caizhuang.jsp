...
<ul>
    ...
    <li class="goods-products">
        <span><a href="../subpages/caizhuang_kouhong.jsp"><img src="../images/kouhong.jpg" alt="" width="250" height="215" class="main-img"></a></span>
        <div class="goods-title">
            <a href="../subpages/caizhuang_kouhong.jsp">口红</a>
        </div>
        ...
        <span class="goods-money">￥10.00</span>
        <span class="goods-shop-name"><a href=""><img src="../images/icon/kefu.png" width="20" height="20"></a></span>
    </li>

    <li class="goods-products">
        <span><a href="../subpages/caizhuang_yanying.jsp"><img src="../images/yanying.jpg" alt="" width="250" height="215" class="main-img"></a></span>
        <div class="goods-title">
            <a href="../subpages/caizhuang_yanying.jsp">眼影</a>
        </div>
        <div class="goods-label">
            <ul>
                <li><a class="procuts-label" title="包邮">包邮</a></li>
        ...
        <span class="goods-money">￥5.00</span>
        <span class="goods-shop-name"><a href=""><img src="../images/icon/kefu.png" width="20" height="20"></a></span>
    </li>
