...
<div class="products-show-box-title">
    <ul>
        ...
        <li>-</li>
        <li><a class="active-title">男士短袖</a></li>
    ...
    <div id="outBox">
        <div class="leftBox">
            <div class="normalBox w">
                <div class="w" id="n"><img src="../images/nanshishangyi.jpg"></div>
            </div>
            <div class="botBox">
            </div>
        </div>
        ...
        <div class="products-box-mid-content">
            <h1 style="font-size: 16px;">男士短袖</h1>
            <ul class="ul-box">
                <li>
                    <table width="490" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="65" height="40"><div align="center">官网价格：</div></td>
                        <td width="347" class="price" style="text-decoration:line-through;color: #666666;">￥100.00</td>
                    </tr>
                        <tr>
                            <td width="65" height="40"><div align="center">VIP价格：</div></td>
                            <td width="347" class="price">￥69.4</td>
                        </tr>
                    <tr>
...
<script type="text/javascript" charset="utf-8">
    function redirectionhtml(){
        var url=encodeURI("男士短袖");
        window.location.href = "user-order.jsp?image=../images/nanshishangyi.jpg&name="+url+"&price=69.4";
    }
</script>
<script type="text/javascript" charset="utf-8">
    function gocart(){
        var url=encodeURI("男士短袖");
        window.location.href = "../cart.jsp?image=images/nanshishangyi.jpg&name="+url+"&price=69.4";
    }
</script>
<!--选项卡js-->
