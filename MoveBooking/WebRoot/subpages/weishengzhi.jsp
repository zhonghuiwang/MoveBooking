...
<div class="products-show-box-title">
    <ul>
        ...
        <li>-</li>
        <li><a class="active-title">卫生纸</a></li>
    ...
    <div id="outBox">
        <div class="leftBox">
            <div class="normalBox w">
                <div class="w" id="n"><img src="../images/weishengzhi.jpg"></div>
            </div>
            <div class="botBox">
            </div>
        </div>
                    ...
                    <table width="490" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td width="347" class="price">
                                ...
                                <li><label><input name="size" type="radio" value="" />S</label></li>
                                    <li><label><input name="size" type="radio" value="" />M</label></li>
                                    <li><label><input name="size" type="radio" value="" />L</label></li>
                            </ul>
                            </td>
                        </tr>
                        <tr>
                            <td height="40" width="65"><div align="center">种类：</div></td>
                            <td class="time">
                                <ul class="statistics2">
                <li><label><input name="color" type="radio" value="" />香印</label></li>
                <li><label><input name="color" type="radio" value="" />猫王</label></li>
                <li><label><input name="color" type="radio" value="" />洁柔</label></li>
                                </ul></td>
                        </tr>
                        <tr>
...
<ul class="shop-title">欧亚超市
    <li>公司名称：欧亚超市</li>
    <li>保证金：1000￥</li>
    <li>所在地：内蒙古乌兰浩特市</li>
    <li>地址：内蒙古乌兰浩特市明度家居</li>
...
<div class="detail-title">
    ...
    <div class="detail" id="con_two_1">
        四层卫生纸，厚实不易撕破，舒适柔软，并且该商品参与了公益宝贝计划，每卖出一份都有0.5元贡献给慈善事业！
    </div>
    <div class="detail2" id="con_two_2">
        <table width="978" border="0" cellpadding="0" cellspacing="0" class="pinglun" >
            <tr bgcolor="#fafafa">
                ...
                <td width="404" style="font-size: 14px;">挺好的，挺好的，很柔软</td>
            ...
            <tr bgcolor="#fafafa">
                ...
                <td width="404" style="font-size: 14px;">很不错，用着很好</td>
                <td width="404"><div align="center" style="font-size: 14px;color: #666666;">2013-01-13 15:06</div></td>
            </tr>
            <tr bgcolor="#fafafa">
                <td width="86" height="80"><div align="center" style="font-size: 14px;">王夏林</div></td>
                <td width="404" style="font-size: 14px;">很好，不容易撕破</td>
                <td width="404"><div align="center" style="font-size: 14px;color: #666666;">2013-01-13 15:06</div></td>
            </tr>
        </table>
...
<script type="text/javascript" charset="utf-8">
    function redirectionhtml(){
        var url=encodeURI("卫生纸大甩卖");
        window.location.href = "user-order.jsp?image=../images/weishengzhi.jpg&name="+url+"&price=9.9";
    }
</script>
<script type="text/javascript" charset="utf-8">
    function gocart(){
        var url=encodeURI("卫生纸大甩卖");
        window.location.href = "../cart.jsp?image=images/weishengzhi.jpg&name="+url+"&price=9.9";
    }
</script>
<!--选项卡js-->
