...
<div class="products-show-box-title">
    <ul>
        ...
        <li>-</li>
        <li><a class="active-title">纯棉浴巾</a></li>
    ...
    <div id="outBox">
        <div class="leftBox">
            <div class="normalBox w">
                <div class="w" id="n"><img src="../images/maojin.jpg"></div>
            </div>
            <div class="botBox">
            </div>
        </div>
        ...
        <div class="products-box-mid-content">
            <h1 style="font-size: 16px;">纯棉浴巾</h1>
            <ul class="ul-box">
                <li>
...
<div class="detail-title">
    ...
    <div class="detail" id="con_two_1">
        纯棉毛巾，舒适柔软，并且该商品参与了公益宝贝计划，每卖出一份都有0.5元贡献给慈善事业！
    </div>
    <div class="detail2" id="con_two_2">
        <table width="978" border="0" cellpadding="0" cellspacing="0" class="pinglun" >
            ...
            <tr bgcolor="#fafafa">
                ...
                <td width="404" style="font-size: 14px;">很好，是纯棉的</td>
                <td width="404"><div align="center" style="font-size: 14px;color: #666666;">2013-01-13 15:06</div></td>
            </tr>
        </table>
...
<script type="text/javascript" charset="utf-8">
    function redirectionhtml(){
        var url=encodeURI("纯棉浴巾");
        window.location.href = "user-order.jsp?image=../images/maojin.jpg&name="+url+"&price=30";
    }
</script>
<script type="text/javascript" charset="utf-8">
    function gocart(){
        var url=encodeURI("纯棉浴巾");
        window.location.href = "../cart.jsp?image=images/maojin.jpg&name="+url+"&price=30";
    }
</script>
<!--选项卡js-->
