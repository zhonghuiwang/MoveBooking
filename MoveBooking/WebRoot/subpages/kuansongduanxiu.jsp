...
<div class="products-show-box-title">
    <ul>
        ...
        <li>-</li>
        <li><a class="active-title">宽松短袖</a></li>
    ...
    <div id="outBox">
        <div class="leftBox">
            <div class="normalBox w">
                <div class="w" id="n"><img src="../images/kuansongduanxiu.jpg"></div>
            </div>
            <div class="botBox">
            </div>
        </div>
        ...
        <div class="products-box-mid-content">
            <h1 style="font-size: 16px;">宽松短袖</h1>
            <ul class="ul-box">
                <li>
                    <table width="490" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="65" height="40"><div align="center">官网价格：</div></td>
                        <td width="347" class="price" style="text-decoration:line-through;color: #666666;">￥80.00</td>
                    </tr>
                        <tr>
                            <td width="65" height="40"><div align="center">VIP价格：</div></td>
                            <td width="347" class="price">￥49.9</td>
                        </tr>
                    <tr>
...
<div class="detail-title">
    ...
    <div class="detail" id="con_two_1">
       纯棉制作，面料舒适，并且该商品参与了公益宝贝计划，每卖出一份都有0.5元贡献给慈善事业！
    </div>
    <div class="detail2" id="con_two_2">
        <table width="978" border="0" cellpadding="0" cellspacing="0" class="pinglun" >
            ...
            <tr bgcolor="#fafafa">
                ...
                <td width="404" style="font-size: 14px;">很不错，穿着很好</td>
                <td width="404"><div align="center" style="font-size: 14px;color: #666666;">2013-01-13 15:06</div></td>
            </tr>
            <tr bgcolor="#fafafa">
...
<script type="text/javascript" charset="utf-8">
    function redirectionhtml(){
        var url=encodeURI("宽松短袖");
        window.location.href = "user-order.jsp?image=../images/kuansongduanxiu.jpg&name="+url+"&price=49.9";
    }
</script>
<script type="text/javascript" charset="utf-8">
    function gocart(){
        var url=encodeURI("宽松短袖");
        window.location.href = "../cart.jsp?image=images/kuansongduanxiu.jpg&name="+url+"&price=49.9";
    }
</script>
<!--选项卡js-->
