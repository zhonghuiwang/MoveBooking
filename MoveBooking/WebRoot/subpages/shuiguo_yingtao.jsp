...
<div class="products-show-box-title">
    <ul>
        ...
        <li>-</li>
        <li><a class="active-title">樱桃</a></li>
    ...
    <div id="outBox">
        <div class="leftBox">
            <div class="normalBox w">
                <div class="w" id="n"><img src="../images/yingtao.jpg"></div>
            </div>
            <div class="botBox">
            </div>
        </div>
                    ...
                    <table width="490" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td width="347" class="price">
                                ...
                                <li><label><input name="size" type="radio" value="" />3斤</label></li>
                                    <li><label><input name="size" type="radio" value="" />5斤</label></li>
                                    <li><label><input name="size" type="radio" value="" />10斤</label></li>
                            </ul>
                            </td>
                        </tr>
                        <tr>
                            <td height="40" width="65"><div align="center">果子大小</div></td>
                            <td class="time">
                                <ul class="statistics2">
                <li><label><input name="color" type="radio" value="" />大果</label></li>
                <li><label><input name="color" type="radio" value="" />中果</label></li>
                <li><label><input name="color" type="radio" value="" />小果</label></li>
                                </ul></td>
                        </tr>
                        <tr>
...
<ul class="shop-title">张晓蔬菜水果专卖店
    <li>公司名称：张晓蔬菜专卖店</li>
    <li>保证金：1000￥</li>
    <li>所在地：内蒙古乌兰浩特市</li>
    <li>地址：内蒙古乌兰浩特市曙光小区西侧门市</li>
...
<div class="detail-title">
    ...
    <div class="detail" id="con_two_1">
      鲜嫩多汁，酸甜可口，并且该商品参与了公益宝贝计划，每卖出一份都有0.5元贡献给慈善事业！
    </div>
    <div class="detail2" id="con_two_2">
        <table width="978" border="0" cellpadding="0" cellspacing="0" class="pinglun" >
            <tr bgcolor="#fafafa">
                ...
                <td width="404" style="font-size: 14px;">挺好的，挺好的，很好吃</td>
            ...
            <tr bgcolor="#fafafa">
                ...
                <td width="404" style="font-size: 14px;">很不错，很新鲜</td>
                <td width="404"><div align="center" style="font-size: 14px;color: #666666;">2013-01-13 15:06</div></td>
            </tr>
            <tr bgcolor="#fafafa">
...
<script type="text/javascript" charset="utf-8">
    function redirectionhtml(){
        var url=encodeURI("樱桃");
        window.location.href = "user-order.jsp?image=../images/yingtao.jpg&name="+url+"&price=25";
    }
</script>
<script type="text/javascript" charset="utf-8">
    function gocart(){
        var url=encodeURI("樱桃");
        window.location.href = "../cart.jsp?image=images/yingtao.jpg&name="+url+"&price=25";
    }
</script>
<!--选项卡js-->
