...
<ul>
    ...
    <li class="goods-products">
        <span><a href="../subpages/hufu_hufupin.jsp"><img src="../images/hufupin.jpg" alt="" width="250" height="215" class="main-img"></a></span>
        <div class="goods-title">
            <a href="../subpages/hufu_hufupin.jsp">护肤品</a>
        </div>
        ...
        <span class="goods-money">￥355.00</span>
