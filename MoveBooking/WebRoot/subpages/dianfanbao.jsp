...
<div class="products-show-box-title">
    <ul>
        ...
        <li>-</li>
        <li><a class="active-title">电饭煲</a></li>
    ...
    <div id="outBox">
        <div class="leftBox">
            <div class="normalBox w">
                <div class="w" id="n"><img src="../images/dianfanbao.jpg"></div>
            </div>
            <div class="botBox">
            </div>
        </div>
                ...
                <li>
                    <table width="490" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td class="time">
                                <ul class="statistics2">
                <li><label><input name="color" type="radio" value="" />粉色</label></li>
                <li><label><input name="color" type="radio" value="" />黑色</label></li>
                <li><label><input name="color" type="radio" value="" />蓝色</label></li>
                                </ul></td>
                        </tr>
                        <tr>
...
<ul class="shop-title">华声电器
    <li>公司名称：华声电器</li>
    <li>保证金：5000￥</li>
    <li>所在地：内蒙古乌兰浩特市</li>
    <li>地址：内蒙古乌兰浩特市火车站对面华声电器</li>
...
<div class="detail-title">
    ...
    <div class="detail" id="con_two_1">
       本品牌电饭煲，功能齐全，可提前预约做饭时间，为您提供很大的便利，并且该商品参与了公益宝贝计划，每卖出一份都有0.5元贡献给慈善事业！
    </div>
    <div class="detail2" id="con_two_2">
        <table width="978" border="0" cellpadding="0" cellspacing="0" class="pinglun" >
            <tr bgcolor="#fafafa">
                ...
                <td width="404" style="font-size: 14px;">挺好的，挺好的，很实用</td>
...
<script type="text/javascript" charset="utf-8">
    function redirectionhtml(){
        var url=encodeURI("电饭煲");
        window.location.href = "user-order.jsp?image=../images/dianfanbao.jpg&name="+url+"&price=185.00";
    }
</script>
<script type="text/javascript" charset="utf-8">
    function gocart(){
        var url=encodeURI("电饭煲");
        window.location.href = "../cart.jsp?image=images/dianfanbao.jpg&name="+url+"&price=185.00";
    }
</script>
<!--选项卡js-->
