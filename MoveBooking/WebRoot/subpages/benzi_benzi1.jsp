...
<div class="products-show-box-title">
    <ul>
        ...
        <li>-</li>
        <li><a class="active-title">本子</a></li>
    ...
    <div id="outBox">
        <div class="leftBox">
            <div class="normalBox w">
                <div class="w" id="n"><img src="../images/benzi1.jpg"></div>
            </div>
            <div class="botBox">
            </div>
        </div>
                ...
                <li>
                    ...
                    <tr>
                        ...
                        <tr>
                            ...
                            <td width="347" class="price">￥10.00</td>
                        </tr>
                    <tr>
                    ...
                    <table width="490" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td width="347" class="price">
                                ...
                                <li><label><input name="size" type="radio" value="" />3本</label></li>
                                    <li><label><input name="size" type="radio" value="" />5本</label></li>
                                    <li><label><input name="size" type="radio" value="" />10本</label></li>
                            </ul>
                            </td>
                        </tr>
                        <tr>
                            <td height="40" width="65"><div align="center">本子大小</div></td>
                            <td class="time">
                                <ul class="statistics2">
...
<script type="text/javascript" charset="utf-8">
    function redirectionhtml(){
        var url=encodeURI("本子");
        window.location.href = "user-order.jsp?image=../images/benzi1.jpg&name="+url+"&price=10";
    }
</script>
<script type="text/javascript" charset="utf-8">
    function gocart(){
        var url=encodeURI("本子");
        window.location.href = "../cart.jsp?image=images/benzi1.jpg&name="+url+"&price=10";
    }
</script>
<!--选项卡js-->
