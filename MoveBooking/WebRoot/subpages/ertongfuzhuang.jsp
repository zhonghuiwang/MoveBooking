...
<div class="products-show-box-title">
    <ul>
        ...
        <li>-</li>
        <li><a class="active-title">儿童服装</a></li>
    ...
    <div id="outBox">
        <div class="leftBox">
            <div class="normalBox w">
                <div class="w" id="n"><img src="../images/ertongfuzhuang.jpg"></div>
            </div>
            <div class="botBox">
            </div>
        </div>
        ...
        <div class="products-box-mid-content">
            <h1 style="font-size: 16px;">儿童服装</h1>
            <ul class="ul-box">
                <li>
                    <table width="490" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="65" height="40"><div align="center">官网价格：</div></td>
                        <td width="347" class="price" style="text-decoration:line-through;color: #666666;">￥166.9</td>
                    </tr>
                        <tr>
                            <td width="65" height="40"><div align="center">VIP价格：</div></td>
                            <td width="347" class="price">￥95.0</td>
                        </tr>
                    <tr>
...
<div class="detail-title">
    ...
    <div class="detail" id="con_two_1">
     纯棉面料，柔软舒适，并且该商品参与了公益宝贝计划，每卖出一份都有0.5元贡献给慈善事业！
    </div>
...
<script type="text/javascript" charset="utf-8">
    function redirectionhtml(){
        var url=encodeURI("儿童服装");
        window.location.href = "user-order.jsp?image=../images/ertongfuzhuang.jpg&name="+url+"&price=95.0";
    }
</script>
<script type="text/javascript" charset="utf-8">
    function gocart(){
        var url=encodeURI("儿童服装");
        window.location.href = "../cart.jsp?image=images/ertongfuzhuang.jpg&name="+url+"&price=95.0";
    }
</script>
<!--选项卡js-->
